...
export function PageHeader({
  ...
  return (
    <header className="relative overflow-hidden border-b border-line px-5 pb-12 pt-28 sm:pb-16 sm:pt-32 md:px-10 md:pb-24 md:pt-40">
      ...
      <h1 className="mt-5 max-w-4xl break-words font-display text-4xl leading-[0.92] tracking-tight text-foreground sm:mt-6 sm:text-5xl md:text-7xl lg:text-8xl">
        {title}
      </h1>
      {description ? (
